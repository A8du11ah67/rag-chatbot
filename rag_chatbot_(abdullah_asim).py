# -*- coding: utf-8 -*-
"""RAG Chatbot (Abdullah Asim)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1o0NBPjHLpqOemSofDdfP2USvOi-atsHJ
"""
...
gr.Interface(
    fn=chat,
    inputs=gr.Textbox(lines=2, placeholder="Ask me anything about nike,adidas", label="Your Question"),
    outputs=gr.Textbox(label="Answer"),
    title="🔎 Web-based RAG Chatbot",
    description="Ask questions about Retrieval-Augmented Generation based on content scraped from the web."
).launch(share=True)
